...
var express = require('express'),
    ...
    uberStrategy = require('passport-uber'),
    https = require('https'),
...
// ROUTES
    require('./server/config/routes.js')(app, https, passport, uberStrategy, clientID, clientSecret, ServerID, sessionSecret);
